	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'wpboxy' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'wpboxy' ); ?></th>
			</tr>
		</thead>
		<tbody>
